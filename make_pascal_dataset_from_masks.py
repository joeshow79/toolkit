...
IMG_PATH = "/Users/jsvm/Downloads/T/instant_noodels_traindata/NG/PNGImages"
MASK_PATH = "/Users/jsvm/Downloads/T/instant_noodels_traindata/NG/PedMasks"
ANNOTATION_PATH = "/Users/jsvm/Downloads/T/instant_noodels_traindata/NG/Annotation"
...
def make_annotation(mask_path):
    ...
    with open(annot_filepath, 'wt') as f:
        ...
        print("Image filename : \"PennFudanPed/PNGImages/{}".format(img_filename), file=f)
        print("Image size (X x Y x C) : 672 x 512 x 1", file=f)
        print("Database : \"The Penn-Fudan-Pedestrian Database\"", file=f)
        print("Objects with ground truth : {} {{ \"PASpersonWalking\" \"PASpersonWalking\" }}".format(len(rects)), file=f)
        ...
        index = 0
        for rect in rects:
            print("# Details for pedestrian {} (\"PASpersonWalking\")".format(index+1), file=f)
            print("Original label for object {} \"PASpersonWalking\" : \"PennFudanPed\"".format(index+1), file=f)
            print("Bounding box for object {} \"PASpersonWalking\" (Xmin, Ymin) - (Xmax, Ymax) : ({}, {}) - ({}, {})".format(index, \
                    rects[index][0][0], rects[index][0][1], \
                    rects[index][0][0] + rects[index][1], \
                    rects[index][0][1] + rects[index][2]), file=f)
            print("Pixel mask for object {} \"PASpersonWalking\" : \"PennFudanPed/PedMasks/{}\"".format(index+1, mask_filename), file=f)
...
if __name__ == '__main__':
    ...
    make_annotation("/Users/jsvm/Downloads/T/instant_noodels_traindata/NG/PedMasks/1582254522665434.mask.png")
