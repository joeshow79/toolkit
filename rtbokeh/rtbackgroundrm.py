...
if __name__ == '__main__':
    ...
    while True:
        ...
        if ret == True:
            ...
            blured_background_image=filters.gaussian_filter(orig_input_image.copy(),5)
            #Option: 
            background=blured_background_image

            mask=prediction>0
            merged_image=background.copy()
            merged_image[mask]=orig_input_image[mask]

            cv2.imshow('rtbokeh',merged_image)
